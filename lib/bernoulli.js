(function() {
	...
	extend (bp, {
	    ...
	    newParams: function(p) { return new BernoulliParams (this._params) },
	    newCounts: function(c) { return new BernoulliCounts (extend ({ params: this }, c)) },
    ...
    function BernoulliCounts (counts, params) {
        var bc = this
	extend (bc, {
    ...
    function BernoulliParams (params) {
        var bp = this
	extend (bp, {
	    _params: params || {},
	    _logYes: {},
    ...
    module.exports.BernoulliParams = BernoulliParams
