(function() {
  ...
  function Simulator (conf) {
    ...
    extend (sim,
	      ...
	      excludeAncestralTerms: conf.excludeAncestralTerms,
	      termAssociationCutoff: conf.termAssociationCutoff,
